...
background-size: cover`}} >
                <Stack direction="row" textAlign='center' alignItems='center' spacing={2} justifyContent="space-between" sx={{ padding: '10%' }} >
                    <Box flex={4} p={2} sx={{ display: { xs: "none", sm: "block" } }}>
                        <Typography variant="h1" >Welcome to Social Pedia</Typography>
                        <Typography variant="h4" color='white' >Please Sign Up to continue your discovery</Typography>
                    </Box>
